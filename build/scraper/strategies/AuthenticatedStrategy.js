 ...
 * @private
 */
AuthenticatedStrategy._loadJobDetails = (page_1, jobId_1, ...args_1) => __awaiter(void 0, [page_1, jobId_1, ...args_1], void 0, function* (page, jobId, timeout = 2000) {
    const pollingTime = 50;
    let elapsed = 0;
    let loaded = false;
    yield (0, utils_1.sleep)(pollingTime);
 ...
 * @private
 */
AuthenticatedStrategy._paginate = (page_1, tag_1, ...args_1) => __awaiter(void 0, [page_1, tag_1, ...args_1], void 0, function* (page, tag, paginationSize = 25, timeout = 2000) {
    ...
    try {
        ...
        if (yield page.evaluate((applyBtnSelector) => {
            ...
            while (elapsed < timeout * 1000) {
                ...
                const dialog = yield page.$(exports.selectors.applyLinkModal);
                if (dialog) {
                    const applyBtn = yield dialog.$(exports.selectors.applyBtn);
                    yield (applyBtn === null || applyBtn === void 0 ? void 0 : applyBtn.click());
                }
